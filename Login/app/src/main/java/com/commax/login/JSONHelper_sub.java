        ...
        try {
            if (type.equals("v1"))
            {
                ...
                if (params[2].equals("13")) {
                    ...
                    // params[0] : type  , [1] : param1 , [2] : param1 , [3] : change password
                    ...
                    urlConnection.setRequestProperty("accept-language", "{ko|en|jp}");
                    urlConnection.setRequestProperty("host", host);
                    Log.d(TAG, "Token : " + params[3]);
                    urlConnection.setRequestProperty("authorization", "Bearer " + params[3]);
                ...
                SubActivity.getInstance().Accss_Uc_register();
                Log.d(TAG," Access UC Register");
