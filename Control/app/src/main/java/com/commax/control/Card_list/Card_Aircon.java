 ...
 */
public class Card_Aircon extends LinearLayout implements View.OnClickListener {
    ...
    public Card_Aircon(Context context) {
        super(context);
        init(context);
    }

    public Card_Aircon(Context context, DeviceInfo devicedata) {
        super(context);
    ...
    getOtherValue
    > airTemperature
    0:thermostatMode (or switchBinary)
    1:thermostatRunMode
    2:thermostatSetpoint
    */
    ...
    private int getDeviceairTemperature() {
        ...
        try {
            getvalue = Integer.parseInt(m_devicedata.getValue()); //airTemperature
        } catch (Exception e) {
            //e.printStackTrace();
        }
