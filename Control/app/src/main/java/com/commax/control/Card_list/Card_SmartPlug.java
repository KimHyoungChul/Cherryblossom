 ...
 */
public class Card_SmartPlug extends LinearLayout implements View.OnClickListener {
    ...
    public Card_SmartPlug(Context context) {
        super(context);
        init(context);
    }

    public Card_SmartPlug(Context context, DeviceInfo devicedata) {
        super(context);
    ...
    private void updateDevice() {
        ...
        m_received_electricValue = getDeviceEctricValue(0);
        m_text_title.setText(m_devicedata.getNickName());
