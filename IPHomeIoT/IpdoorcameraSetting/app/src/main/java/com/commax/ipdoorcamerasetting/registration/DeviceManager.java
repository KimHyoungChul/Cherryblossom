...
import com.commax.ipdoorcamerasetting.udp.Client;
import com.commax.ipdoorcamerasetting.udp.Server;
...
//    final int CLIENT_PORT_NO = 9050;
   ...
   final int SERVER_PORT_NO = 39900; //월패드, 받는 포트(자신 월패드)
   final int CLIENT_PORT_NO = 39901; //도어폰, 보내는 포트(상대방 도어폰)
     ...
     * @param device
     */
    public void sendUdpBroadcast(Device device) {
     ...
     * @return
     */
    public String getAssignIPBroadcast(Device device) {
