...
//                    Log.d(TAG, "json : " + json);
            ...
            if (status == HttpURLConnection.HTTP_OK) {
                ...
                aboutFile.writeFile(TypeDef.create_account, TypeDef.yes);
                aboutFile.writeFile(TypeDef.id, params[3]);
                aboutFile.writeFile(TypeDef.password, String.valueOf(password.length()));
                aboutFile.writeFile(TypeDef.resourceNo, resourceNo);
                aboutFile.writeFile(TypeDef.mac_address, params[5]);
                //2016-11-11  Access API변동으로 인한 수정 사항
                aboutFile.writeFile(TypeDef.workType,params[8]);
                aboutFile.writeFile(TypeDef.ProductModel, params[6]);
