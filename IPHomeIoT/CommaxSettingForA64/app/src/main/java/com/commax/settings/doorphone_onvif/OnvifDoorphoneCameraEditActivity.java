 ...
 * 도어폰 카메라 편집 액티비티
 */
public class OnvifDoorphoneCameraEditActivity extends CommonActivity implements OnvifNameChangeListener {
    ...
    private void initListView() {
        ...
        OnvifEditDooorphoneCameraListAdapter adapter = new OnvifEditDooorphoneCameraListAdapter(this, R.layout.list_item_edit_doorphone_camera, devices);
    ...
    public void checkAutocloseActivity() {
        ...
        final ListView deviceList = (ListView) findViewById(R.id.registeredDoorphoneCameraList);
        List<OnvifDevice> devices = ((OnvifEditDooorphoneCameraListAdapter) deviceList.getAdapter()).getDevices();
    ...
    public void launchCameraDeleteActivity(View view) {
        Intent intent = new Intent(this, OnvifDoorphoneCameraDeleteActivity.class);
    ...
    private void saveEdit() {
        ...
        List<OnvifDevice> devices = ((OnvifEditDooorphoneCameraListAdapter) deviceList.getAdapter()).getAllData();
    ...
    private void updateContentProvider(String newDeviceName, String ipAddress) {
        ...
        contentValues.put(ContentProviderConstants.OnvifDoorCameraDeviceEntry.COLUMN_NAME_DEVICE_NAME, newDeviceName);

        ContentProviderManager.updateOnvifDoorCameraName(this, contentValues, ipAddress);
