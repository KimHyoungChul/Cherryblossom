...
public class DeviceServerIp {

    private static final int DEVICE_PROVIDER_INDEX = 5;

    private Context context;

    public DeviceServerIp(Context context) {
...
//	}
    ...
    public String getValueProvider() {
        ...
        return new SettingProvider(context).getValue(DEVICE_PROVIDER_INDEX);
    }
...
//		}
        ...
        boolean ret = new SettingProvider(context).setValue(DEVICE_PROVIDER_INDEX,
                ip);
//        if (ret) {
