...
public class InitDataPopup extends Dialog {


    private final Context mContext;
    private final InitDataListener mListener;


    public InitDataPopup(Context context, InitDataListener listener) {
        ...
        setCancelable(true);
        setContentView(R.layout.popup_reset_data);
     ...
     * @return 팝업창 객체
     */
    public InitDataPopup cancelable(boolean flag) {
        setCancelable(flag);
        return this;
    }
