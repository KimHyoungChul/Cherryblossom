...
import com.commax.settings.screensaver.Screensaver;
import com.commax.settings.screensaver.ScreensaverModeConstants;
import com.commax.settings.wallpad.Dongho;

import java.util.ArrayList;
import java.util.List;

import static com.commax.settings.content_provider.ContentProviderConstants.OnvifDoorCameraDeviceEntry.COLUMN_NAME_IS_OK;
...
public class ContentProviderManager {
    ...
    /**
     * 이전 홈스크린도움말 사용여부 데이터 삭제
     *
     * @param context
     */
    public static void deletePreviousUseValueTip(Context context) {
        int result =
                context.getContentResolver().delete(ContentProviderConstants.UseValueTipEntry.CONTENT_URI,
                        null, null);
    }
     ...
     * @param contentValues
     */
    public static void saveUseValueTip(Context context, ContentValues contentValues) {


        Uri cursor =
                context.getContentResolver().insert(ContentProviderConstants.UseValueTipEntry.CONTENT_URI,
                        contentValues);
     ...
     * 홈스크린도움말 사용여부 값 가져옴
     */
    public static String getUseValueTip(Context context) {
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(ContentProviderConstants.UseValueTipEntry.CONTENT_URI,
                    null,
                    null,
                    null,
                    null);
        ...
        String useValueTip = null;
        if (cursor != null && cursor.getCount() != 0) {
            cursor.moveToFirst();


            useValueTip = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.UseValueTipEntry.COLUMN_NAME_USE_VALUE_TIP));
    ...
    public static String getUseValueInfo(Context context) {
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(ContentProviderConstants.UseValueInfoEntry.CONTENT_URI,
                        null,
                        null,
                        null,
                        null);
    ...
    public static boolean isOnvifDoorCameraIpExistOnContentProvider(final Context context, String ip) {
        ...
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(ContentProviderConstants.OnvifDoorCameraDeviceEntry.CONTENT_URI,
                        null,
    ...
    public static List<OnvifDevice> getAllOnvifDoorCamera(Context context) {
        ...
        for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
            ...
            String isOk = cursor.getString(cursor
                    .getColumnIndex(COLUMN_NAME_IS_OK));
    ...
    /**
     * Custom 도어폰 카메라 모든 데이터 삭제
     *
     * @param context
     */
    public static void deleteAllCustomDoorCamera(Context context) {
        int result =
                context.getContentResolver().delete(ContentProviderConstants.DoorCameraEntry.CONTENT_URI,
                        null, null);
    }


    /**
     * Custom 도어폰 카메라 데이터 저장
     *
     * @param context
     * @param contentValues
     */
    public static void saveCustomDoorCamera(Context context, ContentValues contentValues) {


        Uri cursor =
                context.getContentResolver().insert(ContentProviderConstants.DoorCameraEntry.CONTENT_URI,
                        contentValues);
    ...
    /**
     * Custom 도어폰 카메라 이름 update
     *
     * @param context
     * @param contentValues
     */
    public static void updateCustomDoorCameraName(Context context, ContentValues contentValues, String ip) {


        int result =
                context.getContentResolver().update(ContentProviderConstants.DoorCameraEntry.CONTENT_URI,
                        contentValues, ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_IPV4 + "=?", new String[] {ip});


    }

    /**
     * Custom 도어폰 카메라가 Content Provider에 존재하는지 체크
     *
     * @param context
     * @return
     */
    public static boolean isCustomDoorCameraIpExistOnContentProvider(final Context context, String ip) {
        String[] args = {ip};
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(ContentProviderConstants.DoorCameraEntry.CONTENT_URI,
                    null,
    ...
    /**
     * 모든 Custom 도어폰 카메라 항목 가져옴
     *
     * @param context
     * @return
     */
    public static List<CustomDevice> getAllCustomDoorCamera(Context context) {
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(ContentProviderConstants.DoorCameraEntry.CONTENT_URI,
                    null,
        ...
        List<CustomDevice> deviceInfos = new ArrayList<>();
        ...
        for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor.moveToNext()) {
            ...
            String modelName = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_MODEL_NAME));
            String mac = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_MAC));
            String usn = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_USN));
            String ipv4 = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_IPV4));
            String ipv4gateway = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_IPV4_GATEWAY));
            String ipv4subnet = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_IPV4_SUBNET));
            String dns = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_DNS));
            String sipNo = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_SIP_NO)); //2017-01,24,yslee::SIP 번호 항목 추가함
            String webPort = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_WEBPORT));
            String rtspPort = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_RTSPPORT));
            String firstStreamUrl = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_FIRST_STREAM_URL));
            String secondStreamUrl = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_SECOND_STREAM_URL));
            String isOK = cursor.getString(cursor
                    .getColumnIndex(ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_IS_OK)); //2017-01,24,yslee::IS_OK 항목 추가함

            deviceInfo = new CustomDevice();
            deviceInfo.setModelName(modelName);
            deviceInfo.setMac(mac);
            deviceInfo.setUsn(usn);
            deviceInfo.setIpv4(ipv4);
            deviceInfo.setIpv4gateway(ipv4gateway);
            deviceInfo.setIpv4subnet(ipv4subnet);
            deviceInfo.setDns(dns);
            deviceInfo.setWebPort(webPort);
            deviceInfo.setRtspPort(rtspPort);
            deviceInfo.setFirstStreamUrl(firstStreamUrl);
            deviceInfo.setSecondStreamUrl(secondStreamUrl);
            deviceInfo.setIsOk(isOK);
    ...
    public static boolean isOnvifCctvIpExistOnContentProvider(final Context context, String ip) {
        ...
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(ContentProviderConstants.OnvifCctvEntry.CONTENT_URI,
                    null,
    ...
    public static String getWallpadPassword(Context context) {
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(ContentProviderConstants.WallpadPasswordEntry.CONTENT_URI,
                        null,
                        null,
                        null,
                        null);
    ...
    public static Dongho getDongho(Context context) {
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(ContentProviderConstants.DonghoEntry.CONTENT_URI,
                        null,
                        null,
                        null,
                        null);
    ...
    public static String getCallTime(Context context) {
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(ContentProviderConstants.CallTimeEntry.CONTENT_URI,
                        null,
                        null,
                        null,
                        null);
    ...
    public static String getMovieRecordTime(Context context) {
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(ContentProviderConstants.MovieRecordTimeEntry.CONTENT_URI,
                        null,
                        null,
                        null,
                        null);
    ...
    public static String getMovieAutoSave(Context context) {
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(ContentProviderConstants.MovieAutoSaveEntry.CONTENT_URI,
                        null,
                        null,
                        null,
                        null);
    ...
    public static String getSmartphoneCall(Context context) {
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(ContentProviderConstants.SmartPhoneCallEntry.CONTENT_URI,
                        null,
                        null,
                        null,
                        null);
    ...
    public static String getPreviousSelectedMode(Context context) {
        Cursor cursor = null;
        try {
            cursor = context.getContentResolver().query(ContentProviderConstants.ScreenSaverEntry.CONTENT_URI,
                        null,
                        null,
                        null,
                        null);
     ...
     * @param ipAddress
     */
    public static void deleteCustomDoorCamera(Context context, String ipAddress) {
        int result =
                context.getContentResolver().delete(ContentProviderConstants.DoorCameraEntry.CONTENT_URI,
                        ContentProviderConstants.DoorCameraEntry.COLUMN_NAME_IPV4 + "=?", new String[]{ipAddress});
    }
