 ...
 */
public class CustomDooorphoneCameraListAdapter extends ArrayAdapter<CustomDevice> {


    private CustomNameChangeListener mListener;
    private String LOG_TAG = CustomDooorphoneCameraListAdapter.class.getSimpleName();
    private final LayoutInflater mLayoutInflater;
    private final List<CustomDevice> mDatas;
    private final Context mContext;


    public CustomDooorphoneCameraListAdapter(Context context, int resource, List<CustomDevice> devices) {
