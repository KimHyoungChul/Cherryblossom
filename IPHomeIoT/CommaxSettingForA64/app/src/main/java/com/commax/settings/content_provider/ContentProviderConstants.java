...
public class ContentProviderConstants {
     ...
     * 홈스크린도움말 사용여부
     */
    public static class UseValueTipEntry implements BaseColumns {
        //같은 테이블 이름이 있으면 오류 발생
        public static final String TABLE_NAME = "UseValueTipTable";
        public static final String _ID = "_id";
        public static final String COLUMN_NAME_USE_VALUE_TIP = "useValueTip";
