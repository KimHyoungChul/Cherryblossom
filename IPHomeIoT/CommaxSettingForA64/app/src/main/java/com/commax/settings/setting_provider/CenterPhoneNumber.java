...
public class CenterPhoneNumber {
    ...
    private static final int CENTERNUM_PROVIDER_INDEX = 8;

    private Context context;

    public CenterPhoneNumber(Context context) {
...
//	}
    ...
    public String getValueProvider() {
        ...
        return new SettingProvider(context).getValue(CENTERNUM_PROVIDER_INDEX);
    }
...
//		}
        ...
        boolean ret = new SettingProvider(context).setValue(CENTERNUM_PROVIDER_INDEX,
                ip);
//        if (ret) {
