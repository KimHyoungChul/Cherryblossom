...
public class LocalServerIp {
    ...
    public LocalServerIp(Context context) {
...
//	}
    ...
    public String getValueProvider() {
        ...
        return new SettingProvider(context).getValue(LOCAL_PROVIDER_INDEX);
    }
...
//		}
        ...
        boolean ret = new SettingProvider(context).setValue(LOCAL_PROVIDER_INDEX,
                ip);
//        if (ret) {
