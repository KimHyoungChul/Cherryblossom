...
public class UpdateServerIp {

    private static final int UPDATE_PROVIDER_INDEX = 3;

    private Context context;

    public UpdateServerIp(Context context) {
...
//	}
    ...
    public String getValueProvider() {
        ...
        return new SettingProvider(context).getValue(UPDATE_PROVIDER_INDEX);
    }
...
//		}
        ...
        boolean ret = new SettingProvider(context).setValue(UPDATE_PROVIDER_INDEX,
                ip);
//        if (ret) {
