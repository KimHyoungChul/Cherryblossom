 ...
 */
public class CustomEditDooorphoneCameraListAdapter extends ArrayAdapter<CustomDevice> {


    private CustomNameChangeListener mListener;
    private String LOG_TAG = CustomEditDooorphoneCameraListAdapter.class.getSimpleName();
    private final LayoutInflater mLayoutInflater;
    private final List<CustomDevice> mDatas;
    private final Context mContext;


    public CustomEditDooorphoneCameraListAdapter(Context context, int resource, List<CustomDevice> devices) {
