 ...
 */
public class DeleteCctvListAdapter extends ArrayAdapter<OnvifDevice> {


    private NameChangeListener mListener;
    private String LOG_TAG = DeleteCctvListAdapter.class.getSimpleName();
    private final LayoutInflater mLayoutInflater;
    private final List<OnvifDevice> mDatas;
    private final Context mContext;


    public DeleteCctvListAdapter(Context context, int resource, List<OnvifDevice> devices) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            if(TypeDef.OP_NEWDELETE_ADAPTOR_ENABLE) {
                convertView = mLayoutInflater.inflate(R.layout.list_item_delete_cctv2,
                        parent, false);
            } else {
                convertView = mLayoutInflater.inflate(R.layout.list_item_delete_cctv,
                        parent, false);
            }
        }
