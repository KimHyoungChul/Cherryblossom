 ...
 */
public class More_StandbyPower_no_cutoff extends LinearLayout implements View.OnClickListener{
    String TAG = More_StandbyPower_no_cutoff.class.getSimpleName();
    ...
    View cutoff_upper_bar;
    LinearLayout cutoff_text_layout;
    LinearLayout cutoff_button_layout;
    // layout
    ...
    * */
    ...
    public More_StandbyPower_no_cutoff(Context context) {
        super(context);
//        init(context);
    }

    public More_StandbyPower_no_cutoff(Context context, DeviceInfo devicedata) {
        super(context);
    ...
    void init(Context context)
    {
        ...
        cutoff_upper_bar = (View)findViewById(R.id.cutoff_layout_up_bar);
        cutoff_text_layout = (LinearLayout)findViewById(R.id.cutoff_mode_text_layout);
        cutoff_button_layout = (LinearLayout)findViewById(R.id.cutoff_button_layout);

        cutoff_upper_bar.setVisibility(GONE);
        cutoff_text_layout.setVisibility(GONE);
        cutoff_button_layout.setVisibility(GONE);
