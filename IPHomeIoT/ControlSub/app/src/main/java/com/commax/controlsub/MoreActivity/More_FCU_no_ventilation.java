 ...
 */
public class More_FCU_no_ventilation extends LinearLayout implements View.OnClickListener{

    String TAG = More_FCU_no_ventilation.class.getSimpleName();
    ...
    public More_FCU_no_ventilation(Context context) {
        super(context);
        init(context);
    }

    public More_FCU_no_ventilation(Context context, DeviceInfo devicedata) {
        super(context);
        Log.d(TAG , "More_FCU");
