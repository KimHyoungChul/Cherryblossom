...
public class InfoTools {
    ...
    public boolean getCreateAccountState() {
        /* Getting unselected information items */
        Properties mProperty = new Properties();
        FileInputStream fis = null;
        boolean result = false;
        Log.d("InfoTools", "junhwe === : sing : " + Environment.getExternalStorageDirectory() );
        try {
            File file = new File( "/mnt/sdcard/Cmxdata/" + NameSpace.CREATE_ACCOUNT_PROPERTIES);
            ...
            if (file.exists()) {
                ...
                try {
                    ...
                    for (int i = 1; i <= 17; i++) {
                        ...
                        if (proValue != null) {
                            Log.d("InfoTools", "junhwe === : sing : " + proValue);
                        }
                    }
                    fis.close();
                } catch (Exception e) {
                ...
                Log.d("InfoTools", "junhwe === : sing : file not exit" );
            }
