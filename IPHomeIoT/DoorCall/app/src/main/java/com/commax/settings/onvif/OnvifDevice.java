package com.commax.settings.onvif;
...
public class OnvifDevice implements Parcelable {
    private String name; //등록할 디바이스 명
    private String nickname; //임시 디바이스 명(2017-01-06,yslee::added)
    ...
    private String isOk; //디바이스 사용 가능 여부
    ...
    public OnvifDevice(String _name, String _ipAddress, String _newIPAddress, String _mac, String _sipPhoneNo, String _port, String _id, String _password, String _alias, String _isOk, String _isUseStaticIp, String _streamUrl) {
        this.name = _name;
