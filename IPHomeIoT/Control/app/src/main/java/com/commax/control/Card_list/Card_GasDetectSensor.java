 ...
 */
public class Card_GasDetectSensor extends LinearLayout implements View.OnClickListener {

    static final String TAG = Card_GasDetectSensor.class.getSimpleName();
    //todo
    ...
    public Card_GasDetectSensor(Context context) {
        super(context);
        Log.d(TAG, "context");
        init(context);
    }

    public Card_GasDetectSensor(Context context, DeviceInfo devicedata) {
        super(context);
    ...
    private void init(Context context) {
        ...
        rootView = inflater.inflate(R.layout.device_gasdetectsensor, this); // from : 가져올 layout 지정
