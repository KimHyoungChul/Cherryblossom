 ...
 */
public class Card_Boiler extends LinearLayout implements View.OnClickListener {
    ...
    static final String TAG = "Card_Boiler";
    ...
    private String MY_SWITCH_ON = TypeDef.BOILDE_MODE_HEAT;
    private String MY_SWITCH_OFF = TypeDef.SWITCH_OFF;

    public Card_Boiler(Context context) {
        super(context);
        init(context);
    }

    public Card_Boiler(Context context, DeviceInfo devicedata) {
        super(context);
    ...
    private void init(Context context){
        ...
        rootView = inflater.inflate(R.layout.device_boiler, this); // from : 가져올 layout 지정
        ...
        */
        ...
        setMarqueeSpeed(m_text_title, 4.0f);
    ...
    protected boolean setMarqueeSpeed(TextView tv, float speed) {
        ...
        try {
            ...
            if (marquee != null) {
                ...
                //Log.d(TAG,"setMarqueeSpeed " + mf.getFloat(marquee));
                mf.setFloat(marquee, speed);
                bresult = true;
            }else {
                //Log.d(TAG,"setMarqueeSpeed is null");
            }
        ...
        public void run() {
            ...
            try {
                ...
                while(true) {
                    ...
                    //if(!bSetSpeed) bSetSpeed = setMarqueeSpeed(m_text_title, 4.0f); //todo
    ...
    */
    ...
    private boolean getDeviceValue() {
        ...
        try {
            if (m_ID_thermostatMode != -1) {
                if (m_devicedata.getOtherValue(m_ID_thermostatMode).equalsIgnoreCase(MY_SWITCH_ON))
    ...
    private int getDevicethermostatSetpoint() {
        ...
        try {
            if (m_ID_thermostatSetpoint != -1) {
                getvalue = Integer.parseInt(m_devicedata.getOtherValue(m_ID_thermostatSetpoint)); //1:thermostatSetpoint
            }
        } catch (Exception e) {
            //e.printStackTrace();
        }
    ...
    private void controlDevice(String value) {
        ...
        MainActivity.getInstance().dataManager.setOnOrOffAddSort( //0:thermostatMode
    ...
    private void controlDevice_Setpoint(String value) {
        ...
        if(!value.equalsIgnoreCase(m_LastSetttingValue)) {
            ...
            MainActivity.getInstance().dataManager.setOnOrOffAddSort( //1:thermostatSetpoint
                    m_devicedata.getRootUuid(),
                    m_devicedata.getRootDevice(),
    ...
    private void updateDevice() {
        ...
        //Log.d(TAG, "updateDevice ... " + m_devicedata.getNickName() + "-" + m_devicedata.getValue() + "-" + m_devicedata.getOtherValue(0) + "-" + m_devicedata.getOtherValue(1));
