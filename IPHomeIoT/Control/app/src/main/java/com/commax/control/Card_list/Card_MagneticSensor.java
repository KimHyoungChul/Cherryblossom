 ...
 */
public class Card_MagneticSensor extends LinearLayout implements View.OnClickListener {

    static final String TAG = Card_MagneticSensor.class.getSimpleName();
    //todo
    ...
    public Card_MagneticSensor(Context context) {
        super(context);
        Log.d(TAG, "context");
        init(context);
    }

    public Card_MagneticSensor(Context context, DeviceInfo devicedata) {
        super(context);
    ...
    private void init(Context context) {
        ...
        rootView = inflater.inflate(R.layout.device_magneticsensor, this); // from : 가져올 layout 지정
