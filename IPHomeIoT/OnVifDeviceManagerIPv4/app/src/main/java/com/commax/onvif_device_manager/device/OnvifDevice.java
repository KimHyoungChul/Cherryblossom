...
public class OnvifDevice implements Parcelable{
    ...
    public OnvifDevice(String _name, String _ipAddress, String _newIPAddress, String _mac, String _sipPhoneNo, String _port, String _id, String _password, String _alias, String _isConfirmed, String _isUseStaticIp) {
        this.name = _name;
